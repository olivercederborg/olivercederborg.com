...
import { type ContactFormData, contactSchema } from '@side-projects/schemas'
import { cn } from '@utils/cn'
import { type HTMLMotionProps, type MotionProps, type Variants, motion } from 'framer-motion'
...
export function ContactForm() {
  ...
  const [state, formAction] = useFormState(send, defaultValues)
  ...
  return (
    ...
    >
      ...
      <SubmitButton>{false ? 'Sending...' : 'Send it'}</SubmitButton>

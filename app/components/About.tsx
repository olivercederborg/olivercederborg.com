				...
				<section className='col-span-full md:col-span-6 xl:col-span-8'>
					<article>
						...
						<p className='mt-6 text-lg font-light leading-relaxed text-dark-400 dark:text-dark-200'>
							My name is Oliver Cederborg. I am 24 years old, I live in Copenhagen, Denmark,
							and I&apos;m a self-taught designer and developer.
							<br />
							<br />
							Digital design has been my main focus for many years, specifically UI/UX, but I
							have the past years shifted my focus to front-end development, which I have
							...
							<br />
							<br />I try to challenge myself by diving head-first into the unknown, learning
							the skills along the way, needed to complete the task.
						</p>
					</article>
